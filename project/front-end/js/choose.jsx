...
import backgroundImageWithOverlay from "../img/background-image-with-overlay.png";
import icon2 from "../img/icon-2.svg";
import icon from "../img/Icon.svg";
import microbioHero1 from "../img/microbio-hero-1.png";
import "../css/choose.css";

export const Body = () => {
  const agroUrl = "/agro.html"; // altere para a página do agro quando estiver pronta
  const saudeUrl = "https://microbio.uniexames.com.br/cms/inicio"; // altere para a URL do portal Saúde
  ...
  return (
    <div className="body">
      <div className="main">
        ...
        <div className="div">
          ...
          <div className="content">
            ...
            <a className="background" href={agroUrl}>
        ...
        <div className="div">
          ...
          <div className="content-2">
            ...
            <a className="background-2" href={saudeUrl} >
              <div className="overlay-shadow" />
      ...
      {/* ELEMENTOS CENTRAIS E CABEÇALHO */}
